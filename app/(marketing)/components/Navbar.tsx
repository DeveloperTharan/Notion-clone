      ...
      <div className="navbar-start">
        ...
        <div className="hidden 4xl:block">
          <div className="dropdown dropdown-hover">
            <label
              tabIndex={0}
              className="hover:bg-base-200 text-sm px-3 py-1 rounded-md cursor-pointer group flex gap-[6px]"
            >
              Products
              <span className="mt-1">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-[2px] z-[1] p-2 shadow bg-white rounded-md w-52"
            >
              <li>
        ...
        <button className="hover:bg-base-200 text-sm px-3 py-1 rounded-md cursor-pointer hidden 4xl:block">
          Pricing
        </button>
      </div>
            ...
            <div className="flex gap-4">
              ...
              {!isAuthenticated && !isLoading && (
                <>
                  ...
                  <div className=" text-xl text-base-content font-extralight mt-1">
                    |
                  </div>
                  <div className="flex gap-1">
